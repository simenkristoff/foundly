 ...
 * ItemCellLayout consists of three classes, Header, Body, and Footer. The
 * Layout is structured extends BorderPane, and is structured with the Item's
 * image on the left-hand side, and the Item's content in the center.
 */
public class ItemCellLayout extends BorderPane {
	...
	private final DateTimeFormatter DATEPATTERN = DateTimeFormatter.ofPattern("dd.MM.YY HH:mm");
	...
	private void initialize() {
		...
		footer.setDate(item.getDate().format(DATEPATTERN));
		...
		image = new Image(App.getApiUrl() + "/img/" + item.getImage());
	 ...
	 * The Class Footer.
	 */
	static private class Footer extends AnchorPane {

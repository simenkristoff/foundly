...
/**
 * The Class DepthManager.
 * Creates a shadow effect for a given node and a specified depth level.
...
public class DepthManager {
    ...
    /**
     * Adds shadow effect to the node,
    ...
    /**
     * Generates a new container node in order to prevent

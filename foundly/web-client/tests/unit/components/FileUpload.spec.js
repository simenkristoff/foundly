...
describe('FileUpload.vue', () => {
  ...
  test('Test if only image-files are accepted', () => {
    ...
    // In case of an invalid file-input, the component will emit 'invalid-file' and return
    ...
    // In case of an valid file-input, the component will emit 'input' along with the filename and call processFile()
  ...
  // Test file upload function. We will expect the component to call FileService.upload with the selected file.
  // If the promise is resolved the component should emit 'file-uploaded' and set the selected file to null/undefined
  ...
  // Test a failed file upload request. We will expect the component to call FileService.upload with the selected file.
  // If the promise is rejected the component should emit 'upload-failed' and set the selected file to null/undefined
  it('Test if a failed upload is handled correctly', (done) => {
    FileService.upload = jest.fn(() => Promise.reject())
    setTimeout(() => {

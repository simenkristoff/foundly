              ...
              <div class="item">
                ...
                <div class="item-content">
                  <div class="item-header">
                    ...
                    <div class="state"
                    :class="item.state === 'FOUND' ? 'state-found' : 'state-lost'"
...
export default {
  ...
  computed: {
    ...
    filteredList(){
      return this.stateFilter.filter(item => {
        return item.description.toLowerCase().includes(this.search.toLowerCase()) || item.title.toLowerCase().includes(this.search.toLowerCase())
      })
    }
  },
  methods: {
